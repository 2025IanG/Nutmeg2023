...
public class DriveForDist extends CommandBase {
     ...
     */
    public DriveForDist(SwerveDriveSubsystem drivetrain, double distance) {
     ...
     */
    public DriveForDist(SwerveDriveSubsystem drivetrain, double distRight, double distForward, String fileID) {
    ...
    public DriveForDist(SwerveDriveSubsystem drivetrain, double distRight, double distForward, double poseAngle, String fileID) {
        this.drivetrain = drivetrain;
